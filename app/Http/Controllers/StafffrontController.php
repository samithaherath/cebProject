...
class StafffrontController extends Controller
{
    ...
    public function index()
    {
		 ...
		 $homestaff = DB::table("staff")->paginate(9);

       // return view('dashboard.pages.manage_members',['members'=>$members]);
        return view('frontend/pages/team',compact('homestaff','designations'));
    }
    ...
    public function fetch_data(Request $request)
    {
        if($request->ajax())
		{
			$homestaff = DB::table('staff')->paginate(9);
			 $designations = DB::select("select * from designations");
			return view('frontend/pages/teamdata',compact('homestaff','designations'))->render();
		}
    }
