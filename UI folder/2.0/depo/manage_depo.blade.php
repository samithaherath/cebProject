            ...
            <div class="card-content">
                <h4 class="card-title">Depos </h4>
                     ...
                     <form action=""  method="post">
						  ...
						  <a href="create_dep" type="button" class="btn btn-primary center-block">Create Depo</a>
                        ...
                        <thead>
                            <tr >
                                ...
                                <th scope="col">  <div class="checkbox">
                                    ...
                                    <th scope="col">ID</th>
                                    <th scope="col">Work Place Name</th>
                                    <th scope="col">Number of Deops</th>
                                ...
                                <tr>
									<td></td>
                                        ...
                                        <td class="td-actions text-left">
                                               ...
                                               <a href="edit_dep" type="button"><i class="material-icons btn-primary">person</i></a>
