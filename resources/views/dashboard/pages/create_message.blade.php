                       ...
                       <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    ...
                                    <input type="text" name="union_id" class="form-control autocomplete_txt" data-type="union_id" id='union_id' >
                                    <span class="help-block">Please enter Union ID</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <input type="text" name="emp_id" class="form-control autocomplete_txt" data-type="employee_id" id='employee_id' >
