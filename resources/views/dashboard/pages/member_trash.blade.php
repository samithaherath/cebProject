                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$member->union_id}}</td>
                                            <td>{{$member->employee_id}}</td>
                                            <td>{{$member->name}}</td>
                                            <td class="td-actions text-left">
                                               
                                                
                                                 <a href="{{route('member.restore',$member->id)}}" onclick="return confirm('Are you sure you want to restore?')" type="button"><i class="material-icons btn-primary">restore_page</i></a>
                                              

                                                 <button type="submit" formaction="{{action('MembershipController@destroy',$member->id)}}" onclick="return confirm('Are you sure you want to Delete?')" ><i class="material-icons  btn btn-danger ">delete</i> </button>
