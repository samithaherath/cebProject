...
<li>
 ...
 <div class="collapse" id="componentsExamples">
    <ul class="nav">
        <li>
            <a href="{{route('mymessages',Auth::user()->id)}}">
                <span class="sidebar-mini"> MM </span>
                <span class="sidebar-normal"> My Messages </span>
            </a>
        </li>
...
<li>
    ...
    <ul class="nav">
        <li>
            <a href="myevents">
                ...
                <span class="sidebar-normal"> Upcomming Events </span>
            </a>
        </li>
 ...
 <div class="collapse" id="componentsExamples0">
    <ul class="nav">
      <li>
            <a href="{{route('mygroups',Auth::user()->id)}}">
                <span class="sidebar-mini"> MG </span>
                <span class="sidebar-normal">My Groups </span>
            </a>
        </li>
